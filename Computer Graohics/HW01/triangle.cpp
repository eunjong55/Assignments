...
void init()
{
    ...
    {GL_VERTEX_SHADER, "triangles.vert"}, // for vertex shader (position)
    {GL_FRAGMENT_SHADER, "triangles.frag"}, // for fragment shader (color)
    {GL_NONE, NULL}
    };

    GLuint program = LoadShaders(shaders); // compile shader and create program object.
